...
public static class ServiceRegistrar
{
    ...
    public static void Register(IServiceCollection services, MediatRServiceConfiguration configuration)
    {
        ...
        services.TryAdd(new ServiceDescriptor(typeof(IMediator), sp => sp.GetRequiredService<IMediator>(), configuration.Lifetime));
